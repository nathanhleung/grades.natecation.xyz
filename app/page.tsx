  ...
  return (
    <main className="flex flex-col w-full">
      <div className="flex flex-col text-center justify-center p-6 sm:p-12 md:p-16 md:w-[85%] lg:w-[60%] md:mx-auto">
        <h1 className="text-4xl mb-4 text-uclaDarkerBlue hover:opacity-50 font-bold"><a href="/">UCLA Grade Distributions</a></h1>
        <h2 className="text-lg text-gray-400">Data from Fall 2021, Winter 2022, Spring 2022, and Summer 2022, brought to you by <a href="/shoutouts">40+ UCLA students</a></h2>
      </div>
