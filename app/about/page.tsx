    ...
    return (
        <main className="flex flex-col w-full">
            <div className="flex flex-1 flex-col justify-center p-6 sm:p-12 md:p-16 pb-0 sm:pb-0 md:pb-0 md:max-w-[85%] lg:max-w-[60%] md:mx-auto">
                <h1 className="text-4xl text-center mb-6 text-black font-bold">About</h1>
                <div className="text-justify">
                    <p>
                        ...
                        </a> for 2021-22 grade distributions.
                    </p>
                    <a
                    ...
                    <p>
                        <a className="text-uclaBlue hover:opacity-50" href="/shoutouts">40+ UCLA students</a> crowdfunded $130 and we sent a check to UCLA Information Practices.
                    </p>
                    <a
                    ...
                    <p>
                        This website was developed over the course of a few weeks in late June and early July, and the grade distribution data is now{" "}
                        <a
                        ...
                        </a> on the UCLA Google Drive (log into your UCLA Google Account to access).
                    </p>
                    <a
                        href="https://docs.google.com/spreadsheets/u/1/d/1kF7eK8Iyyv_LnE2IY9vg2VEuDuoYi5qO/edit?usp=sharing&ouid=105052985987772221837&rtpof=true&sd=true"
                        target="_blank"
